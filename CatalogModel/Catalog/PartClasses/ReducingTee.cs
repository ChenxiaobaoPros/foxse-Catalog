...
{
	/// <summary>
	/// Тройники переходные и российские равнопроходные
	/// </summary>
	public class ReducingTee
	{
		...
		public int? PipingPointBasis3 { get; set; }
		public int? Id3 { get; set; }
		public PressureRating PressureRating3 { get; set; }
		public EndPreparation EndPreparation3 { get; set; }
		public EndPreparation EndStandard3 { get; set; }
		public ScheduleThickness ScheduleThickness3 { get; set; }
		public FlowDirection FlowDirection3 { get; set; }
		...
		public int Npd3 { get; set; }
		public UnitType NpdUnitType3 { get; set; }

		public float Face1toCenter { get; set; }
		public UnitType Face1toCenterUnits { get; set; }

		public float Face3toCenter { get; set; }
		public UnitType Face3toCenterUnits { get; set; }
	}
}
