...
namespace CatalogModel.Catalog.PartClasses
{
	...
	public class Thredolet
	{
		...
		public float FacetoFittingCrotch { get; set; }
		public UnitType FacetoFittingCrotchUnits { get; set; }

		public float MajorBodyDia { get; set; }
		public UnitType MajorBodyDiaUnits { get; set; }

		public float HoleDia { get; set; }
		public UnitType HoleDiaUnits { get; set; }
	}
}
