...
namespace CatalogModel.Catalog.PartClasses
{
	...
	public class CheckValve
	{
		...
		public float HeightFrmValCen { get; set; }
		public UnitType HeightFrmValCenUnitType { get; set; }

		public float? EqualizerClearance { get; set; }
		public UnitType EqualizerClearanceUnitType { get; set; }
