...
namespace CatalogModel.Catalog.PartClasses
{
	...
	public class SpectacleBlind
	{
		...
		public float CentertoCenter { get; set; }
		public UnitType CentertoCenterUnitType { get; set; }

		public float WebWidth { get; set; }
		public UnitType WebWidthUnitType { get; set; }

		public float WebThickness { get; set; }
		public UnitType WebThicknessUnitType { get; set; }
	}
}
