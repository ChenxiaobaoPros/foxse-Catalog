...
namespace CatalogModel.Catalog.PartClasses
{
	...
	public class GlobeValve
	{
		...
		public UnitType FacetoCenterUnitType { get; set; }

		public float Face1toCenter { get; set; }
		public UnitType Face1toCenterUnitType { get; set; }
		...
		public UnitType DiameterUnitType { get; set; }

		public float? BonnetFlangeDia { get; set; }
		public UnitType BonnetFlangeDiaUnitType { get; set; }

		public float? MountingFlangeDia { get; set; }
		public UnitType MountingFlangeDiaUnitType { get; set; }
	}
}
